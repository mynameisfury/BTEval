...
namespace BoomTownEval.Models
{
    public class RepoModel
    {
        ...
        public partial class License : LicenseBase
    {
    }
    ...
    public partial class Owner
        ...
        public enum EventsUrl { HttpsApiGithubComUsersBoomTownRoiEventsPrivacy };

        public enum FollowingUrl { HttpsApiGithubComUsersBoomTownRoiFollowingOtherUser };

        public enum NodeId { MdEyOk9YZ2FuaXphdGlvbjEyMtQwOty };

        public enum StarredUrl { HttpsApiGithubComUsersBoomTownRoiStarredOwnerRepo };
        ...
        internal class EventsUrlConverter : JsonConverter
        {
            ...
            public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
            {
                if (reader.TokenType == JsonToken.Null) return null;
                var value = serializer.Deserialize<string>(reader);
                if (value == "https://api.github.com/users/BoomTownROI/events{/privacy}")
                {
                    return EventsUrl.HttpsApiGithubComUsersBoomTownRoiEventsPrivacy;
                }
            ...
            public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
            {
                ...
                if (value == EventsUrl.HttpsApiGithubComUsersBoomTownRoiEventsPrivacy)
                {
                    serializer.Serialize(writer, "https://api.github.com/users/BoomTownROI/events{/privacy}");
                    return;
                }
        ...
        internal class FollowingUrlConverter : JsonConverter
        {
            ...
            public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
            {
                if (reader.TokenType == JsonToken.Null) return null;
                var value = serializer.Deserialize<string>(reader);
                if (value == "https://api.github.com/users/BoomTownROI/following{/other_user}")
                {
                    return FollowingUrl.HttpsApiGithubComUsersBoomTownRoiFollowingOtherUser;
                }
            ...
            public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
            {
                ...
                if (value == FollowingUrl.HttpsApiGithubComUsersBoomTownRoiFollowingOtherUser)
                {
                    serializer.Serialize(writer, "https://api.github.com/users/BoomTownROI/following{/other_user}");
                    return;
                }
        ...
        internal class NodeIdConverter : JsonConverter
        {
            ...
            public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
            {
                if (reader.TokenType == JsonToken.Null) return null;
                var value = serializer.Deserialize<string>(reader);
                if (value == "MDEyOk9yZ2FuaXphdGlvbjEyMTQwOTY=")
                {
                    return NodeId.MdEyOk9YZ2FuaXphdGlvbjEyMtQwOty;
                }
            ...
            public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
            {
                ...
                if (value == NodeId.MdEyOk9YZ2FuaXphdGlvbjEyMtQwOty)
                {
        ...
        internal class StarredUrlConverter : JsonConverter
        {
            ...
            public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
            {
                if (reader.TokenType == JsonToken.Null) return null;
                var value = serializer.Deserialize<string>(reader);
                if (value == "https://api.github.com/users/BoomTownROI/starred{/owner}{/repo}")
                {
                    return StarredUrl.HttpsApiGithubComUsersBoomTownRoiStarredOwnerRepo;
                }
            ...
            public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
            {
                ...
                if (value == StarredUrl.HttpsApiGithubComUsersBoomTownRoiStarredOwnerRepo)
                {
                    serializer.Serialize(writer, "https://api.github.com/users/BoomTownROI/starred{/owner}{/repo}");
                    return;
                }
